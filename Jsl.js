	    ...
	    case 'family100': {
            ...
            case 'guess': {
                ...
                if (args[0] === "song") {
                    ...
                    let anu = await fetchJson('https://raw.githubusercontent.com/alena/fungames/main/GuessTheWord.js')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    ...
                    let anu = await fetchJson('https://raw.githubusercontent.com/alena/fungames/main/GuessTheSentence.js')
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    Jsl.sendText(m.chat, `Please Answer The Following Question\n\n${result.soal}\nTime : 60 seconds`, m).then(() => {
...
break
	    ...
	    case 'yts': case 'ytsearch': {
            ...
            break
        case 'google': {
                if (!text) return reply(`Example : ${prefix + command} Jsl shiba inu`)
        ...
        if (!text) return reply(`Example : ${prefix + command} Jsl`)
...
case 'webtonsearch': case 'webtoon':
                ...
                alena.Webtoons(q).then(async data => {
            ...
            case 'drakorxxx':
                if (!text) return reply('What Are You Looking For??')
                await reply(mess.wait)
                alena.Drakor(`${text}`).then(async data => {
            ...
            case 'characterxxx': case 'karakterxxx':
                ...
                await reply(mess.wait)
                alena.Character(q).then(async data => {
            ...
            case 'manga':
                ...
                await reply(mess.wait)
                alena.Manga(`${text}`).then(async data => {
...
break
                    case 'bug': case 'report': {
                    	...
                    	Jsl.sendMessage(`918129624395@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
